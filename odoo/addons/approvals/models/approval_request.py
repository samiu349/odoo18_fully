...
class ApprovalRequest(models.Model):
    ...
    attachment_ids = fields.One2many(comodel_name='ir.attachment', inverse_name='res_id',
                                     domain=[('res_model', '=', 'approval.request')], string='Attachments')
    ...
    def action_approve(self, approver=None):
        ...
        # Removed: message_notify email notification
...
class ApprovalApprover(models.Model):
    ...
    can_edit_user_id = fields.Boolean(compute='_compute_can_edit',
                                      help="Simple users should not be able to remove themselves as approvers because they will lose access to the record if they misclick.")
